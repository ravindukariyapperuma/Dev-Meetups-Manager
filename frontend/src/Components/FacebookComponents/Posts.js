    ...
    return (
        <Col xs={3} key={product.id}>
            <Card style={{width: '100rem'}}>
                <CardContent>
                    <img src={cancel} height={20} width={20}
                         style={{marginLeft: "1%", marginBottom: "0%", textAlign: "center"}}
                         onClick={() => deletePagePost(product.id)}/>
                    <img src={posts} height={80} width={100}
                         style={{marginLeft: "1%", marginBottom: "0%", textAlign: "right"}}/> <br/><br/>
